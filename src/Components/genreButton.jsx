...
const GenreButton = ({ children, updatePopup, deletePopup }) => {
    ...
    return (
        <div>
            <div className="w-full h-[4rem] mb-2 bg-gray-200 font-extrabold text-gray-600 rounded-2xl px-8 py-4 mb-5 flex">
                <div className="w-1/2 hover:text-xl cursor-pointer">
                    {
                        children
                    }
                </div>
                <div className="flex w-1/2 justify-end cursor-pointer ">
